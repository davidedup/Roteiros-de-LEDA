...
public class StudentBSTTest {
	...
	@Test
	public void testSorComparator() {
		fillTree(); // -40 -34 0 2 5 6 9 12 23 67 76 232
		Integer[] array = { 232, 76, 67, 23, 12, 9, 6, 5, 2, 0, -34, -40 };
		assertArrayEquals(array, tree.reverseOrder());
		Integer[] array1 = { 6, -34, -40, 5, 2, 76, 23, 9, 12, 0, 67, 232 };
		Integer[] array2 = { -40, -34, 0, 2, 5, 6, 9, 12, 23, 67, 76, 232 };

		assertArrayEquals(array2, tree.sort(array1));

	}

	// @Test
	// public void testBSTExtended(){
	// fillTree();
	// Integer[] array = { -40,-34,0,2,5,6,9,12,23,67,76,232 };
	// Integer[] aux = tree2.sort(array);
	// assertArrayEquals(array, aux);
	//
	// Integer[] array2 = {232,76,67,23,12, 9,6,5,2, 0, -34, -40};
	//
	// Integer[] aux2 = tree2.reverseOrder();
	//
	// assertArrayEquals(array2, aux2);
	//
	// }
