...
public class StudentAVLTest {
	...
	@Test
	public void testRotationCases() {
		avl.insert(100);
		avl.insert(120);
		avl.insert(140);
		assertArrayEquals(new Integer[] { 120, 100, 140 }, avl.preOrder());

		avl.remove(140);
		avl.insert(110);
		assertArrayEquals(new Integer[] { 110, 100, 120 }, avl.preOrder());
		...
		avl.remove(80);
		avl.insert(95);
		assertArrayEquals(new Integer[] { 95, 90, 100 }, avl.preOrder());
	}
